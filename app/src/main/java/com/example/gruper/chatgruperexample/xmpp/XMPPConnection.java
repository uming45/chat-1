...
//     * property <tt>smack.debugEnabled to true. The system property can be set on the
...
//     * be used.
//     *
//     * @param host the name of the XMPP server to connect to; e.g. <tt>jivesoftware.com.
...
//     *
//     * @param host the name of the XMPP server to connect to; e.g. <tt>jivesoftware.com.
//     * @param port the port on the server that should be used; e.g. <tt>5222.
//     * @throws XMPPException if an error occurs while trying to establish the connection.
//     *      Two possible errors can occur which will be wrapped by an XMPPException --
//     *      UnknownHostException (XMPP error code 504), and IOException (XMPP error code
//     *      502). The error codes and wrapped exceptions can be used to present more
...
//     * <tt>null if not logged in yet. An XMPP address is in the form
...
//    }
//
//    public SmackDebugger startDebugging(Object parent) {
//        // If debugging is enabled, we open a window and write out all network traffic.
//        if (debugger == null) {
//            String point = "org.jivesoftware.smack.debuggers";
//            String id = System.getProperty("smack.debuggerClass");
//            IExtension extension  = Platform.getExtensionRegistry().getExtension(point, id);
//            if (extension == null)
//                extension = Platform.getExtensionRegistry().getExtension(point, "org.jivesoftware.smack.debuggers.enhanced");
//            if (extension == null)
//                extension = Platform.getExtensionRegistry().getExtension(point, "org.jivesoftware.smack.debuggers.lite");
//            if (extension != null) {
//                try {
//                    debugger = (SmackDebugger) extension.getConfigurationElements()[0].createExecutableExtension("class");
//                    debugger.setup(this, parent, writer, reader);
