...
public class MyXMPP {
        ...
        if (!chat_created) {
            Mychat = ChatManager.getInstanceFor(connection).createChat(
                    chatMessage.receiver + "@"
                            + context.getString(R.string.server2),
                    mMessageListener);
            chat_created = true;
        }
    ...
    private class MMessageListener implements ChatMessageListener {
        ...
        public void processMessage(final org.jivesoftware.smack.chat.Chat chat,
            ...
            System.out.println("PESAN BODY"+message.getBody());
...
//                Log.d("PESAN", "PESAN", +message.getBody().toString());
        ...
        private void processMessage(final ChatMessage chatMessage) {
            ...
            Log.e("PESAN FROM SPARK",chatMessage.getBody().toString());

            chatMessage.isMine = false;
            PersonalChatActivity.chatlist.add(chatMessage);
            new Handler(Looper.getMainLooper()).post(new Runnable() {

                @Override
                public void run() {
                    PersonalChatActivity.chatAdapter.notifyDataSetChanged();
                }
            });
        }
